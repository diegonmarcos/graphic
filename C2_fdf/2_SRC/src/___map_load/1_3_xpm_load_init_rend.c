...
/*   Updated: 2025/03/17 13:57:59 by dinepomu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*	mlx_put_image_to_window(x->mlx_ptr, x->win_ptr, x->black_img, \
							x->image_pos_x, x->image_pos_y);
*/
